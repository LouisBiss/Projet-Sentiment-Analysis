...
def get_all_tweets(screen_name):
    ...
    outtweets = [[tweet.id, tweet.user.name, tweet.created_at, tweet.text, tweet.geo, tweet.source, url] for tweet in tweets]

    # write the csv
    with open('tweets.csv', 'w') as f:
        writer = csv.writer(f)
        writer.writerow(["Id", "user", "created_at", "text", "location", "source", "url"])
